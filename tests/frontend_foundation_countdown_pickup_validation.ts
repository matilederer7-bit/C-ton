...
await run("pickup rule: generic labels are not locations; address text or coordinates are; delivery needs nothing", () => {
  ...
  assert.deepEqual(
    describePickupLocation({ option_type: "pickup", label: "איסוף עצמי", latitude: 31.7683, longitude: 35.2137 }),
    {
      ...
      precision: "exact",
      navigation: { exact: true, mode: "coordinates", google_maps_url: "https://www.google.com/maps/dir/?api=1&destination=31.7683%2C35.2137", waze_url: "https://waze.com/ul?ll=31.7683%2C35.2137&navigate=yes" }
    }
  );
