...
console.log("AGENT_WORKSPACE_CONTRACT_PASS agents=2 isolated_paths=pass clean_guard=pass remote_collision_guard=pass unicode_task_names=pass canonical_root=pass single_command=pass reviewer_handoff=pass finish_pushed_head_guard=pass destructive_reset=absent");
