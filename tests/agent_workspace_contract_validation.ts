...
assert.match(output, /AGENT_WORKTREE_BOUNDARY overwrite_existing_path=false discard_uncommitted=false force_push=false/);
...
console.log("AGENT_WORKSPACE_CONTRACT_PASS agents=2 isolated_paths=pass clean_guard=pass destructive_reset=absent");
