...
//   R9  DB guard (069): no capture / release while a renewal is unresolved;
...
try {
  ...
  // ── R9 ──────────────────────────────────────────────────────────────────
  await run("R9 DB guard (069): while a renewal identity is unresolved no capture / recovery / release identity may be minted, and no second renewal identity; a completed renewal never blocks a later one", async () => {
