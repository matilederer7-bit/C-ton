...
- Admin overview Omnisearch now casts heterogeneous deal and participant state
  enums to text before their `UNION`, closing a browser-discovered 500 response
  without broadening the result set, RBAC, or operational authority.
