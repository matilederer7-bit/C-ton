...
| A-8 | ~~Deadline hard cap 7 days; some sellers will ask for 10–14~~ **RESOLVED 2026-09-16 (LONG_HORIZON_DEALS):** no payment-derived cap; the authorization is renewed at the charging boundary (`docs/LONG_HORIZON_AUTHORIZATION_ARCHITECTURE.md`) | — | — |
