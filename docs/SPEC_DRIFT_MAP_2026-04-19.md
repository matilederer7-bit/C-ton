...
- **באפיון (ציטוט היסטורי — DEPRECATED, אינו מדיניות פעילה):** "דדליין לעיסקה לא יעלה על 7 ימים" + "מקסימום עד שבעה ימים קלנדריים, מינימום החל מ 2 שעות". הציטוט נשמר לתיעוד בלבד; מגבלת 7 הימים בוטלה — ראו העדכון בסוף הסעיף.
...
- **תיקון (הצעה היסטורית — בוטלה חלקית):** ולידציה ב-POST /deals: `2h ≤ deadline - now ≤ 7d`. במקביל: אכיפה ב-DB trigger (`deadline <= created_at + interval '7 days'`). החסם העליון של 7 ימים וה-DB trigger בוטלו ולא יבוצעו.
