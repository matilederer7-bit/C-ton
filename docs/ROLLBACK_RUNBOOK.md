...
Nothing to do in the database. All recent migrations are additive (new tables/columns/indexes: 065, 066 and the financial 067/068, all on master and applied on staging). Older code ignores columns it does not know. Leave the schema; see §6.
