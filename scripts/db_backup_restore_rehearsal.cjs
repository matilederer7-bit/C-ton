...
const KEY_TABLES = ["seller_accounts", "deals", "deal_delivery_options", "participants", "platform_fee_money_events", "audit_log", "migration_ledger", "outbox", "payment_attempts", "webhook_events", "operational_cases", "notification_events"];
