...
export const GLOSSARY: readonly GlossaryEntry[] = [
  ...
  { he: "מע\"מ", en: "VAT", note: "Israeli value added tax. Excluded from the 8% fee base — the fee is charged on the gross minus customer VAT." },
  { he: "משלוח", en: "Delivery", note: "Shipping to the buyer. INCLUDED in the fee base, unlike VAT." },
  ...
  { he: "שובר", en: "Voucher", note: "A deal type: a digital entitlement the buyer redeems, with no physical delivery." },
  { he: "כרטיס", en: "Ticket", note: "A deal type: entry to an event, redeemed at the door rather than delivered." },
