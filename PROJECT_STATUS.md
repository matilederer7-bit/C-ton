...
- Hosted proof: `scripts/p07_owner_acceptance_proof.cjs --base-url=… --deal=…` (S1–S7 public/buyer side; S8 seller command center with a disposable synthetic seller) — results recorded below after deploy.
