-- 071 — LONG_HORIZON_DEALS: deal lifetime is decoupled from payment
...
BEGIN
  ...
  -- 071: a re-authorization identity may not rotate while a prior renewal is
  ...
  -- 071: while a renewal is unresolved the CURRENT authorization is unknown —
