...
// Ensure deal_type infrastructure exists at runtime, mirroring migration 038.
// Migration 038 is the canonical source; this guard makes the runtime resilient
// to dev DBs that haven't been bootstrapped recently.
